...
public class MeasureToolbar: UIToolbar, AGSGeoViewTouchDelegate {
  ...
  private let planarLengthMetersThreshold: Double = 10000000
  private let planarAreaSquareMilesThreshold: Double = 1000000
  ...
  private func unit(for geom: AGSGeometry) -> AGSUnit {
    ...
    return selectedGeometry?.geometryType == .polyline ? selectedLinearUnit : selectedAreaUnit
  }
